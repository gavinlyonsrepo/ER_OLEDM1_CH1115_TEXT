...
#include "ER_OLEDM1_CH1115_TEXT_font.hpp"
...
class ERMCH1115 {
  public:
	...
	~ERMCH1115(){};
	 ...
	 void  OLEDGotoXY(uint8_t column , uint8_t page);
	 void  OLEDChar(unsigned char character);
	 void  OLEDString(const unsigned char *characters);
